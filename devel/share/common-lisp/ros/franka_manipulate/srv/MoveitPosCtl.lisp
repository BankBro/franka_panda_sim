...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoveitPosCtl-request>)))
  ...
  (cl:format cl:nil "# position in world frame, unit: meter~%float32 x~%float32 y~%float32 z~%~%# Euler angles(intrinsic rotation), unit: radian  # TODO: order~%float32 yaw    # z axis~%float32 pitch  # y axis~%float32 roll   # x axis~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoveitPosCtl-request)))
  "Returns full string definition for message of type 'MoveitPosCtl-request"
  (cl:format cl:nil "# position in world frame, unit: meter~%float32 x~%float32 y~%float32 z~%~%# Euler angles(intrinsic rotation), unit: radian  # TODO: order~%float32 yaw    # z axis~%float32 pitch  # y axis~%float32 roll   # x axis~%~%~%~%"))
