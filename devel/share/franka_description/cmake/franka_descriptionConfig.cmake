...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /project/franka_panda_sim_ws/src/franka_description)
  set(franka_description_DEVEL_PREFIX /project/franka_panda_sim_ws/devel)
  ...
  set(franka_description_INSTALL_PREFIX /project/franka_panda_sim_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/project/franka_panda_sim_ws/src/franka_description/${idir}'.  ${_report}")
    endif()
